...
<p>
  <a href="https://github.com/Archerkattri/faster-trellis/releases"><img alt="Release" src="https://img.shields.io/github/v/release/Archerkattri/faster-trellis?color=1f6feb"></a>
  <a href="https://github.com/Archerkattri/faster-trellis/releases"><img alt="Downloads" src="https://img.shields.io/github/downloads/Archerkattri/faster-trellis/total?label=downloads&color=1f6feb"></a>
  <a href="LICENSE"><img alt="License" src="https://img.shields.io/github/license/Archerkattri/faster-trellis?color=0d9488"></a>
</p>
...
- **Sibling:** [`faster-trellis-plus-plus`](https://github.com/Archerkattri/faster-trellis-plus-plus) — the same base model with the HiCache++ (Dynamic Mode Decomposition / Prony) exponential-forecast variant.
